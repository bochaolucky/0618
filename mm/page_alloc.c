					...
					unsigned long mask)
{
	...
	//pr_info("set_pfnblock_flags_mask ||pfn:%ld...\r\n",pfn);
...
{
	pr_info("LIU|enter build_all_zonelists..\r\n");
	...
	pr_info("LIU|build_all_zonelists||vm_total_pages:%lu...\r\n", vm_total_pages);
	/*
...
static void __paginginit free_area_init_core(struct pglist_data *pgdat)
{
	...
	for (j = 0; j < MAX_NR_ZONES; j++) {
		...
		pr_info("free_area_init_core||zone_start_pfn:%lu...\r\n",zone_start_pfn);
