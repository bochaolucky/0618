...
static void __init request_standard_resources(const struct machine_desc *mdesc)
{
	...
	pr_info("request_standard_resources||kernel_code.start:%x...\r\n",kernel_code.start);
	pr_info("request_standard_resources||kernel_code.end :%x...\r\n",kernel_code.end);
	pr_info("request_standard_resources||kernel_data.start :%x...\r\n",kernel_data.start );
	pr_info("request_standard_resources||kernel_data.end :%x...\r\n",kernel_data.end);
	...
	for_each_memblock(memory, region) {
		...
		//pr_info("request_standard_resources||second res->flags:%ld",res->flags);
...
void __init setup_arch(char **cmdline_p)
{
    ...
    pr_info("enter setup_arch ...\n");
	setup_processor();
	pr_info("setup_processor success.\n");
	...
	pr_info("LIU0602|init_mm.start_code: %lx...\n",init_mm.start_code );
	pr_info("LIU0602|init_mm.end_code: %lx...\n",init_mm.end_code);
	pr_info("LIU0602|init_mm.end_data: %lx...\n",init_mm.end_data);
	pr_info("LIU0602|init_mm.brk: %lx...\n",init_mm.brk);
